...
import Logo from "@/media/logo/hermind-infinity.png";
        ...
        <div className="flex w-full h-full justify-between p-[35px]">
          ...
          <div className="flex flex-col w-1/2 gap-y-[16px]">
            <p className="text-[#FFF] text-xl font-bold">
              Go mobile. Stay local. Hermind Mobile.
            </p>
            <p className="text-[#FFF] text-lg">
              Hermind for mobile allows you to connect to your workspace's
            ...
            <Link
              to="https://play.google.com/store/apps/details?id=com.hermind"
              target="_blank"
            >
              <img
                src={GetOnGooglePlay}
          ...
          <div className="flex flex-col items-center justify-center shrink-0 w-1/2 gap-y-[16px]">
            ...
            <p className="text-[#FFF] text-sm w-[300px] text-center">
              Scan the QR code with the Hermind Mobile app to enable live
