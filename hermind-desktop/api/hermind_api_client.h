...
public:
    ...
    using PromptVariablesCallback = std::function<void(const QJsonArray &variables,
                                                       const ApiError &error)>;
    using PromptHistoryCallback = std::function<void(const QJsonArray &history,
                                                     const ApiError &error)>;
    ...
    void promptHistory(const QString &slug, PromptHistoryCallback callback);
    void deletePromptHistoryItem(const QString &slug, int id, OperationCallback callback);
    void clearPromptHistory(const QString &slug, OperationCallback callback);
