...
This Google Apps Script provides the backend for the `google-calendar-agent` skill in Hermind Go server.
...
8. In Hermind, set the system setting `google_calendar_agent_config` to:
   ```json
